This Power BI project focuses on analyzing Plant Co.’s performance across sales, quantity, and profit for 2023 and 2024. I worked on cleaning the data, building the model, and creating interactive dashboards using DAX to track important business metrics. In this project, I explored how the business is performing over time, which countries and products are doing well, and where the company is losing profit. One interesting finding was that even when the quantity sold increased, the profit didn’t always grow — which shows how important margins are. The dashboard is designed to be simple and interactive so users can easily filter by year, product type, and country to get meaningful insights.
